...
class Vendor {
  ...
  bool get isPackageType => isPackageVendor == 1;

  String toRawJson() => json.encode(toJson());

  factory Vendor.fromJson(Map<String, dynamic> json) {
    // print("Vendor ==> $json");
    // print("Package vendor ==> ${json["is_package_vendor"]}");
    // print("Package vendor Type ==> ${json["is_package_vendor"].runtimeType}");
    return Vendor(
      ...
      pickup:
          json["pickup"] == null ? null : int.parse(json["pickup"].toString()),
