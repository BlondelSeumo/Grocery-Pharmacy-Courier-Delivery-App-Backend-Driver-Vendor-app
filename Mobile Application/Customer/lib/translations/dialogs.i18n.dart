...
extension Localization on String {
  ...
  static var _t = Translations("en") +
      ...
      {
        "en": "%s is inviting you to join %s via this referral code: %s",
        "fr": "%s vous invite à rejoindre %s via ce code de parrainage: %s",
        "es":
            "%s te invita a unirte a %s a través de este código de referencia: %s",
        "de": "%s lädt Sie ein, %s über diesen Referenzcode beizutreten: %s",
        "pt":
            "%s está convidando você para se juntar a %s através deste código de referência: %s",
        "ar": "يدعوك %s للانضمام إلى %s عبر رمز الإحالة هذا: %s",
        "ko": "%s 님이이 추천 코드를 통해 %s 에 가입하도록 초대합니다 : %s"
      } +
      {
        "en": "GO TO CART",
        "fr": "ALLER AU PANIER",
        "es": "IR AL CARRITO",
        "de": "ZUM EINKAUFSKORB GEHEN",
        "pt": "IR PARA O CARRINHO",
        "ar": "اذهب إلى عربة التسوق",
        "ko": "카트로 이동"
      } +
      {
        "en": "Keep Shopping",
